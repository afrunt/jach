...
public class COREntryDetail extends NonIATEntryDetail {
    ...
    @ACHField(start = 54, length = 22, name = "Individual Name", inclusion = REQUIRED)
    public String getIndividualName() {
        return individualName;
    }

    public COREntryDetail setIndividualName(String individualName) {
    ...
    @Override
    @ACHField(start = 78, length = 1, values = {"1"}, inclusion = MANDATORY, name = ADDENDA_RECORD_INDICATOR)
