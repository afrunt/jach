...
public abstract class CorporateDetailRecord extends NonIATEntryDetail {
    ...
    public CorporateDetailRecord setIdentificationNumber(String identificationNumber) {
        this.identificationNumber = identificationNumber;
        return this;
    }

    @ACHField(start = 54, length = 4, inclusion = REQUIRED, name = "Number Of Addenda Records")
    public Short getNumberOfAddendaRecords() {
        return numberOfAddendaRecords;
    }

    public CorporateDetailRecord setNumberOfAddendaRecords(Short numberOfAddendaRecords) {
    ...
    public CorporateDetailRecord setReceivingCompanyName(String receivingCompanyName) {
    ...
    public CorporateDetailRecord setDiscretionaryData(String discretionaryData) {
