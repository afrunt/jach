 ...
 */
@ACHRecordType(name = "DNE Entry Detail Record")
public class DNEEntryDetail extends NonIATEntryDetail {
    ...
    public DNEEntryDetail setIdentificationNumber(String identificationNumber) {
    ...
    public DNEEntryDetail setIndividualName(String individualName) {
    ...
    public DNEEntryDetail setDiscretionaryData(String discretionaryData) {
