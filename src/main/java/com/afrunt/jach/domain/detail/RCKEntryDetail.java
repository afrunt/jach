...
public class RCKEntryDetail extends NonIATEntryDetail {
    ...
    public RCKEntryDetail setCheckSerialNumber(String checkSerialNumber) {
    ...
    public RCKEntryDetail setIndividualName(String individualName) {
    ...
    public RCKEntryDetail setDiscretionaryData(String discretionaryData) {
